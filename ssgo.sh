...
#=================================================================#
#   This shadowsocks_go server install script is based on the     #
#   shadowsocks-go.sh script created by teddysun.                 #
#   It's modified for more easily installed on the arukas docker  #
#=================================================================#
